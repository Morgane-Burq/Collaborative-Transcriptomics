...
```
#R?ecriture des lignes et colonnes.
```{r}
...
```
# Cr?ation des listes isoler les couples/pots o? une plante ou deux n'a pas pousser
```{r}
...
```
# Ajustement des types de toutes les donn?es
```{r}
