...
plot_biomasse_Condition<-ggplot(data=data,aes(Condition_hydrique,Biomasse_seche,fill=Condition_hydrique))+
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  labs(x="Hydric Conditions",y="Dry Biomass",fill="Hydric Condition")+
...
ggplot(aes(x=Monoculture_Couple,y=Biomasse_seche,fill=Monoculture_Couple),data=data)+
  ...
  labs(x="Cultural Conditions",y="Dry Biomass",fill="Cultural Conditions")+
...
ggplot(aes(x=RHT_voisin,y=Biomasse_seche,fill=RHT_voisin,),data=data)+
  ...
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  facet_grid(cols=vars(plante_genotype))+
  labs(x="Neighbors RHT Marker",y="Dry Biomass",fill="Neighbors RHT Marker")+
  theme_cowplot()+
  theme(
    legend.position=c(0.001,0.07),
    legend.background = element_rect(fill="lightgrey"),
...
ggplot(aes(x=voisin,y=Biomasse_seche,fill=voisin)
  ...
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  labs(x="Neighbors RHT Marker",y="Dry Biomass",fill="Neighbors genotype")+
  theme_cowplot()+
  theme(
...
ggplot(aes(x=voisin,y=Biomasse_seche,fill=voisin)
  ...
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  labs(x="Neighbors genotype",y="Genotype 118 dry Biomass")+
  theme_cowplot()+
  theme(
    legend.position="none",
    axis.text.x = element_text(angle=90,vjust = 0.5)
...
ggplot(aes(x=voisin,y=Biomasse_seche,fill=voisin)
  ...
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  labs(x="Neighbors genotype",y="Genotype 348 dry Biomass")+
  theme_cowplot()+
  theme(
    legend.position="none",
    axis.text.x = element_text(angle=90,vjust = 0.5)
...
ggplot(aes(x=voisin,y=Biomasse_seche,fill=voisin)
  ...
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  labs(x="Neighbors genotype",y="Genotype 395 dry Biomass")+
  theme_cowplot()+
  theme(
    legend.position="none",
    axis.text.x = element_text(angle=90,vjust = 0.5)
...
ggplot(aes(x=voisin,y=Biomasse_seche,fill=voisin)
  ...
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(position=position_jitter(0),size=0.7,alpha=0.5)+
  labs(x="Neighbors genotype",y="Genotype 131 dry Biomass")+
  theme_cowplot()+
  theme(
    legend.position="none",
    axis.text.x = element_text(angle=90,vjust = 0.5)
