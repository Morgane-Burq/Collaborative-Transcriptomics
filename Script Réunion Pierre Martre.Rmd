...
mmod3.1 <- mmer(Largeur_feuille_2 ~ Structuration_design + Bloc_M+poids_graine,
...
mmod0.1 <- mmer(Surface_feuille_2 ~ 
                Structuration_design 
              + Bloc_M 
              + poids_graine,
                 iters = 10,
...
mmod1 <- mmer(Surface_feuille_2 ~ Structuration_design + Bloc_M,
                 random = ~ plante_genotype,
                 rcov = ~ units, iters = 10,
                 data = data)
summary(mmod1)
...
mmod1.1 <- mmer(Surface_feuille_2 ~ Structuration_design + Bloc_M,
                 random = ~ plante_genotype,
                 iters = 10,
                 data = data[-outlier,])
summary(mmod1.1)
...
mmod2 <- mmer(Surface_feuille_2 ~ Structuration_design + Bloc_M,
                 random = ~ plante_genotype+voisin,
                 iters = 10,
                 data = data)
summary(mmod2)
...
mmod2.1 <- mmer(Surface_feuille_2 ~ Structuration_design + Bloc_M,
                 random = ~ plante_genotype+voisin,
                 iters = 10,
                 data = data[-outlier,])
summary(mmod2.1)
...
mmod3.1 <- mmer(Surface_feuille_2 ~ Structuration_design + Bloc_M,
                 random = ~ gvs(plante_genotype,voisin),
                 rcov = ~ units, iters = 10,
                 data = data[-outlier,])
summary(mmod3.1)
...
lmod3.1 <- lmer(Surface_feuille_2 ~
              Structuration_design
            + Bloc_M
            + poids_graine
            + (1|plante_genotype)
...
```{r}
plot(data$Longueur_feuille_2, data$Surface_feuille_2)
plot(data[,c(9:10,13,23)])
```
