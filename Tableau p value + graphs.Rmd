...
Surface_feuille_2_tableau <- na.omit(as_data_frame(c(aov1$`Pr(>F)`,aov2$`Pr(>F)`,aov3$`Pr(>F)`,cor$estimate,cor$p.value)))
names(Surface_feuille_2_tableau)<-c("Surface feuille 2")
rownames(Surface_feuille_2_tableau)<-c("p - value mod0 vs mod1","p - value mod1 vs mod2","p - value mod2 vs mod3","facteur de correlation entre les BLUES IGE vs DGE","p - value test de correlation : Pearson's product-moment correlation")
